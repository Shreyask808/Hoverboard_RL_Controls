...
with mujoco.viewer.launch_passive(model,data) as viewer:
    while viewer.is_running() and data.time < duration:
        ...
        Ml = -150*data.qpos[pend_hinge_y_qpos_id] + 150*data.qpos[pend_hinge_x_qpos_id] + 0.1*data.qvel[pend_hinge_y_qvel_id]
        Mr = -150*data.qpos[pend_hinge_y_qpos_id] - 150*data.qpos[pend_hinge_x_qpos_id] + 0.1*data.qvel[pend_hinge_y_qvel_id]
