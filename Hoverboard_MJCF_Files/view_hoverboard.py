...
with mujoco.viewer.launch_passive(model,data) as viewer:
    while viewer.is_running() and data.time < duration:
        ...
        Ml = -30*data.qpos[pend_hinge_y_qpos_id] - 200*data.qpos[pend_hinge_x_qpos_id] #+ 0.1*data.qvel[pend_hinge_y_qvel_id] - 0.1*data.qvel[pend_hinge_x_qvel_id]
        Mr = -30*data.qpos[pend_hinge_y_qpos_id] + 200*data.qpos[pend_hinge_x_qpos_id] #+ 0.1*data.qvel[pend_hinge_y_qvel_id] + 0.1*data.qvel[pend_hinge_x_qvel_id]
